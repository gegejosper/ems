...
class AssistantController extends Controller
{
    public function index()
    {
        ...
        return view('assistant.home', compact('dataClub','dataRegion','dataMember','Club', 'Region', 'Member'));
    }
    public function regions()
    {
        ...
        return view('assistant.region', compact('dataRegion','Club', 'Region', 'Member'));
    }
    public function clubs()
    {
        ...
        return view('assistant.clubs', compact('dataClub','Club', 'Region', 'Member'));
    }
    ...
    public function members(){
        ...
        return view('assistant.members',compact('dataMember','dataPosition', 'dataClub', 'dataRegion'));
    }
    ...
    public function viewregions($regionname){
        ...
        $dataMember = Member::where('region','=', $regionname)
                ->latest()
                ->get();
        return view('assistant.regionmemberlist',compact('dataMember','dataPosition', 'dataClub', 'dataRegion'));
    }
    public function viewclub($clubname){
        ...
        $dataMember = Member::where('club','=', $clubname)
            ->latest()    
            ->get();
        return view('assistant.clubmemberlist',compact('dataMember','dataPosition', 'dataClub', 'dataRegion'));
    }
