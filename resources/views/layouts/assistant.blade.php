            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li>
                    <a href="/assistant/home"><i class="fa fa-home"></i> Home </a> 
                  </li>
                  <li>
                    <a href="/assistant/members"><i class="fa fa-group"></i> Members </a> 
                  </li>
                  <li>
                    <a href="/assistant/clubs"><i class="fa fa-puzzle-piece"></i> Clubs </a> 
                  </li>
                  <li>
                    <a href="/assistant/regions"><i class="fa fa-bank"></i> Regions </a> 
                  </li>
...
<div id="accountModal" class="modal fade " role="dialog">
  ...
  <!-- /.row -->
    ...
    <script src="{{ asset('js/assistantaccount.js') }}"></script>
    <!-- jQuery -->
