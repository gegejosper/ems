...
<div class="right_col" role="main">
          ...
          <div class="row">
            <div class="col-lg-12 col-md-4 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h4>Recent Members <a href="/assistant/members" class="pull-right btn btn-info btn-xs"><i class="fa fa-plus"></i> View More</a></h4>
              ...
              <div class="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h4>Recent Clubs <a href="/assistant/clubs" class="pull-right btn btn-info btn-xs"><i class="fa fa-plus"></i> View More</a></h4>
              ...
              <div class="col-lg-6 col-md-4 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h4>Recent Regions <a href="/assistant/regions" class="pull-right btn btn-info btn-xs"><i class="fa fa-plus"></i> View More</a></h4>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table class="table table-striped members">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="/assistant/regions/{{$Region->regioname}}" class="pull-right btn btn-success btn-xs"><i class="fa fa-search"></i> View</a></td> 
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
